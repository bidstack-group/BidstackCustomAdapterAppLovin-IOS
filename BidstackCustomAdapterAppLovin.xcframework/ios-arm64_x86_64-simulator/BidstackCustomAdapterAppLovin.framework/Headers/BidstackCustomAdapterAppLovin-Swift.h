...
#ifndef BIDSTACKCUSTOMADAPTERAPPLOVIN_SWIFT_H
#define BIDSTACKCUSTOMADAPTERAPPLOVIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidstackCustomAdapterAppLovin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("AppLovinBidstackMediationAdapter")
@interface AppLovinBidstackMediationAdapter : ALMediationAdapter
...
@interface AppLovinBidstackMediationAdapter (SWIFT_EXTENSION(BidstackCustomAdapterAppLovin)) <MARewardedAdapter>
...
@interface AppLovinBidstackMediationAdapter (SWIFT_EXTENSION(BidstackCustomAdapterAppLovin)) <MAInterstitialAdapter>
...
@interface AppLovinBidstackMediationAdapter (SWIFT_EXTENSION(BidstackCustomAdapterAppLovin)) <BidstackAdapterDelegate>
